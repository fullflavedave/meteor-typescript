...
/*********************************** Begin setup for main Meteor tests ******************************/
...
/********************************** End setup for main Meteor tests *********************************/
...
/************** End tests for main Meteor type definitions **************/




/************** Begin tests for Handlebars type definitions **************/
...
var result2 = handlebarsTemplate(data);
...
var handlebarsTemplate2 = Handlebars.compile(source2);
handlebarsTemplate2(context2);
...
var handlebarsTemplate3 = Handlebars.compile(source3);
handlebarsTemplate3(context3);
...
var handlebarsTemplate4 = Handlebars.compile(source4);
var data2 = { "people": [
    { "name": "Alan", "id": 1 },
    { "name": "Yehuda", "id": 2 }
]};
handlebarsTemplate4(data2);

var source5 = "<ul>{{#people}}<li>{{> link}}</li>{{/people}}</ul>";
Handlebars.registerPartial('link', '<a href="/people/{{id}}">{{name}}</a>')
var handlebarsTemplate5 = Handlebars.compile(source5);
var data3 = { "people": [
    { "name": "Alan", "id": 1 },
    { "name": "Yehuda", "id": 2 }
]};
handlebarsTemplate5(data3);
...
/************** End tests for Handlebars type definitions **************/



/************** Begin tests for JQuery type definitions **************/
...
/************** End tests for JQuery type definitions **************/



/************** Begin tests for Underscore type definitions **************/

// Removed next line since it was causing a conflict with the JQuery tests.
// $ is already defined in the JQuery type definitions.
//declare var $;
...
/************** End tests for Underscore type definitions **************/